...
var args = Relay.Args.addArg(Relay.Args.defaultArgs(undefined), "test", Curry._1(Relay.Args.make, {
...
var fields = Graphql.Field.make(Graphql.Field.addField(Graphql.Field.empty(undefined), "id", {
          NAME: "Field2",
          VAL: {
